...
#  Decleration means telling the property of the variable , name of the variable and type of the variable 
...
// WHAT IS THE SIZE OF THE SHORT_INT AND INT
...
// g++ practise1.c++ -o practise1.exe
// size practise.exe

// WHAT KIND OF VARIABLE UNINITIALIZED  BSS SEGMENT CONSISTS OF

   #uninit static both local &  global , uninit global variable 

// WHAT KIND OF VARIABLE WILL INITIALIZED DATA SEGMENT CONSISTS OF

    #init static both local & global , init global variable , extern variable 

//  WHAT KIND OF VARIABLE WILL TEXT/CODE SEGMENT CONSISTS OF

    #init local variable , init const both local & global variable 
...
# Logical operator are used to check two or more condition true or false
# && , || , !
...
#  Index is start from 0 // By default function is created globally if some other fiels try 
...
// WHAT ARE THE ADVANTAGES and DISADVANTAGES OF VARIABLE LENGTH ARRAY TYPES 
